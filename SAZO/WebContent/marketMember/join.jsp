...
<script type="text/javascript" src="<%=cp%>/marketMember/js/util.js"></script>
...
<script type="text/javascript">
	...
	var f = document.myForm;
		...
		//비밀번호 길이
		if(f.pwd.value.length<10 ){
			alert("비밀번호 10자이상 입력바랍니다")
			f.pwd.focus();
			return;
		}//end 비밀번호 길이
...
<input type="text" name="addr2" id="sample4_extraAddress" placeholder="참고항목">
